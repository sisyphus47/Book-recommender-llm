...
def recommend_books(query: str, category: str, tone: str):
    try:
        ...
        for _, row in recommendations.iterrows():
            ...
            image_url = str(row.get("large_thumbnail") or "cover-not-found.jpg")
            caption = str(caption)
        ...
        return [("cover-not-found.jpg", "⚠️ Error generating recommendations")]
...
with gr.Blocks(theme=gr.themes.Glass()) as dashboard:
    ...
    output = gr.Gallery(label="Recommended books", columns=8, rows=2, value=[])
